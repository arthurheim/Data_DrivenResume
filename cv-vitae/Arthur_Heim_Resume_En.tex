...
\subsection{Current position(s)}\label{current-positions}
...
\begin{tabular}{lllll}
\toprule
\textbf{Fields} & \textbf{Analytical} & \textbf{Programming} & \textbf{Software/Tools} & \textbf{Languages}\\
\midrule
Labour economics & Applied econometrics & R & Rstudio & French (\emph{native})\\
Economics of Education & Market design & RMarkdown & LaTeX & English (\emph{fluent})\\
Early childhood & Machine learning & Matlab & Stata & $$\\
Gender economics & $$ & Python & $$ & $$\\
\bottomrule
\end{tabular}
\end{table}
...
\item \it{École à 2 ans : Une maternelle plus précoce et plus longue améliore-t-elle la réussite des élèves ?}
\end{cvitems}}
