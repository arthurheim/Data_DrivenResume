...
linkcolor: "ff0080"
urlcolor: "0000ff" 
aboutme: "I am an applied economist working on the design and evaluation of public policies to reduce inequalities and poverty in France. My work is mostly based on randomised experiments and microeconometrics for policy evaluation. I also use market design and implement fair assignment mechanisms for daycare seats in French municipalities. I am currently working as project manager in the Research Evaluation and Statistics department (DSER) of the French National family allowance fund (Cnaf)."
header-includes:
  \usepackage{fontspec}
  \usepackage{float}
  \usepackage{starfont}
