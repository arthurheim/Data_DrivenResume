...
linkcolor: "ff0080"
urlcolor: "0000ff" 
aboutme: "I am an applied economist working on the design and evaluation of public policies to reduce inequalities and poverty in France. I received the Best dissertation award of the French Court of auditors. My work is mostly based on randomised experiments and microeconometrics for policy evaluation."
header-includes:
  \usepackage{fontspec}
  \usepackage{float}
  \usepackage{starfont}
...
\section{Project management $\quad$ \faLaptop}
...
\section{Expertise, consulting and training $\quad$ \faBarChartO}
...
PapersECEC <- PaperDetails %>%
  filter(bibtex_ID %in% c("CarbucciaEtAl2025","CombeHeim2024")) %>% arrange(bibtex_ID) %>% as.tibble() %>% 
...
\section{Languages  $\quad$ \faLanguage}
